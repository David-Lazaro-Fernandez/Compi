    ...
    <section className="py-24 bg-muted/50">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl font-bold tracking-tight mb-4">Más de 20 mil de cotizaciones y contando</h2>
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <Image src="/placeholder.svg" alt="Trustpilot" width={24} height={24} className="h-6 ml-2" />
            ...
            <Card key={index} className="bg-background">
              <CardContent className="p-6">
                <blockquote className="space-y-4">
                  <p className="text-lg">&ldquo;{review.text.replace(review.highlight, `${review.highlight}`)}&rdquo;</p>
        ...
        <div className="text-center">
          <Button variant="outline" size="lg" className="rounded-full hover:text-white">
            Ver más reseñas
          </Button>
        </div>
      </div>
